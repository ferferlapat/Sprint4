...
const VentaArticulos = require('../models').VentaArticulos;
...
module.exports = {
    add: async(req, res, next) => {
        try {
            ...
            for (const detalle of detalles) {
                ...
                // Create and save a VentaArticulo
                const VentaArticulo = await VentaArticulos.create(po);
            }
            /* detalles.map(function(x) {
                ...
                // Create and save a VentaArticulo
                const VentaArticulo = VentaArticulos.create(po);
            }); */
    ...
    list: async(req, res, next) => {
        try {
            ...
            const reg = await models.Venta.findAll({
    ...
    */
    activate: async(req, res, next) => {
        try {
            ...
            const reg2 = await models.Venta.findOne({
